document.addEventListener('DOMContentLoaded', function() {
    ...
    if (applyFilterBtn) {
        applyFilterBtn.addEventListener('click', function() {
            ...
            // window.location.href = `furniture.html?category=${category}&condition=${condition}&priceMin=${priceMin}&priceMax=${priceMax}&material=${material}`;
        });
    }
    ...
    contactButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const productName = card.querySelector('.furniture-title').textContent;
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const productName = this.closest('.furniture-card').querySelector('.furniture-title').textContent;
