document.addEventListener('DOMContentLoaded', function() {
    ...
    if (applyFilterBtn) {
        applyFilterBtn.addEventListener('click', function() {
            ...
            // window.location.href = `other.html?category=${category}&condition=${condition}&priceMin=${priceMin}&priceMax=${priceMax}&location=${location}`;
        });
    }
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const productName = this.closest('.item-card').querySelector('.item-title').textContent;
    ...
    // Add animation to item cards when they appear in viewport
