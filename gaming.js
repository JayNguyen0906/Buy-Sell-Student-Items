document.addEventListener('DOMContentLoaded', function() {
    ...
    if (applyFilterBtn) {
        applyFilterBtn.addEventListener('click', function() {
            ...
            // window.location.href = `gaming.html?type=${type}&platform=${platform}&condition=${condition}&priceMin=${priceMin}&priceMax=${priceMax}`;
        });
    }
    ...
    function showNotification(message) {
        ...
        notification.style.backgroundColor = 'var(--gaming-color)';
    ...
    contactButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const card = this.closest('.gaming-card');
            const sellerName = card.querySelector('.seller-name').textContent;
            const productName = card.querySelector('.gaming-title').textContent;
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const productName = this.closest('.gaming-card').querySelector('.gaming-title').textContent;
    ...
    // Add animation to gaming cards when they appear in viewport
    if ('IntersectionObserver' in window) {
        ...
        document.querySelectorAll('.gaming-card').forEach((card, index) => {
            // Set initial styles
